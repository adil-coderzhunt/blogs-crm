...
import { CompaniesCardView } from "./components/card-view";
import { ListTitleButton } from "../../components";

type View = "card" | "table";

export const WebsiteListPage: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div className="page-container">
      <List
        ...
        title={
          <ListTitleButton toPath="companies" buttonText="Add new Website" />
        }
      >
        <CompaniesCardView
